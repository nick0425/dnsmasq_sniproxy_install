...
install_dnsmasq(){
    ...
    download /etc/dnsmasq.d/custom_netflix.conf https://raw.githubusercontent.com/nick0425/dnsmasq_sniproxy_install/master/dnsmasq.conf
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/nick0425/dnsmasq_sniproxy_install/master/proxy-domains.txt
